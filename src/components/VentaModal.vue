...
<template>
  <Teleport to="body">
    <div v-if="abierto" class="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-[999] p-4">
      
      <div class="bg-white rounded-2xl shadow-2xl w-full max-w-md max-h-[90vh] flex flex-col overflow-hidden transform transition-all border border-blue-100">
        
        <div class="bg-blue-600 p-5 sm:p-6 text-white text-center flex flex-col items-center flex-shrink-0">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.2" stroke="currentColor" class="w-16 h-16 sm:w-20 sm:h-20 mb-2 sm:mb-3 text-blue-100 opacity-80">
            <path stroke-linecap="round" stroke-linejoin="round" d="M18 18.72a9.094 9.094 0 0 0 3.741-.479 3 3 0 0 0-4.682-2.72m.94 3.198l.001.031c0 .225-.012.447-.037.666A11.944 11.944 0 0 1 12 21c-2.17 0-4.207-.576-5.963-1.584A6.062 6.062 0 0 1 6 18.719m12 0a5.971 5.971 0 0 0-.941-3.197m0 0A5.995 5.995 0 0 0 12 12.75a5.995 5.995 0 0 0-5.058 2.772m0 0a3 3 0 0 0-4.681 2.72 8.986 8.986 0 0 0 3.74.477m.94-3.197a5.971 5.971 0 0 0-.94 3.197M15 6.75a3 3 0 1 1-6 0 3 3 0 0 1 6 0Zm6 3a2.25 2.25 0 1 1-4.5 0 2.25 2.25 0 0 1 4.5 0Zm-13.5 0a2.25 2.25 0 1 1-4.5 0 2.25 2.25 0 0 1 4.5 0Z" />
          </svg>

          <h3 class="text-xl sm:text-2xl font-black italic text-white leading-none">Cerrar Negocio</h3>
          <p class="text-blue-100 text-xs sm:text-sm mt-1">Vas a vender a: <strong>{{ animal.nombre }}</strong></p>
        </div>
        ...
        <div class="p-5 sm:p-6 space-y-4 overflow-y-auto">
          ...
          <div v-else class="space-y-4">
            ...
            <div class="flex flex-col sm:flex-row gap-3 pt-4 mt-2 border-t">
              <button @click="emit('close')" class="w-full sm:flex-1 py-3 bg-gray-100 text-gray-500 font-bold hover:bg-gray-200 rounded-xl transition order-last sm:order-first">
                Cancelar
              </button>
              <button @click="confirmarVenta" :disabled="guardando" class="w-full sm:flex-1 py-3 bg-blue-600 text-white rounded-xl font-black shadow-lg hover:bg-blue-700 transition disabled:opacity-50">
